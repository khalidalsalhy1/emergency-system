...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">تعديل بيانات المريض: <?php echo e($patient->full_name); ?></h1>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('medical_history', $record->medical_history ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('allergies', $record->allergies ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('current_medications', $record->current_medications ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('notes', $record->notes ?? '')); ?></textarea>
