...
<?php $__env->startSection('title', 'إضافة مستشفى جديد'); ?>
...
<div class="container-fluid">
    ...
    <div class="card card-primary card-outline shadow">
        <form action="<?php echo e(route('admin.hospitals.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-5 border-left">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="hospital_name" id="hospital_name" class="form-control" required value="<?php echo e(old('hospital_name')); ?>" placeholder="أدخل اسم المستشفى الكامل">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="city" id="city" class="form-control" required value="<?php echo e(old('city')); ?>" placeholder="مثلاً: صنعاء">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="district">المديرية <span class="text-danger">*</span></label>
                                    <input type="text" name="district" id="district" class="form-control" required value="<?php echo e(old('district')); ?>" placeholder="مثلاً: السبعين">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control" required value="<?php echo e(old('phone')); ?>" placeholder="رقم التواصل الرئيسي">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="hospital@example.com">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" name="latitude" id="lat_input" class="form-control" required value="<?php echo e(old('latitude', '15.3694')); ?>">
                            </div>
                            <div class="col-6">
                                <label for="lng_input">خط الطول (Lng)</label>
                                <input type="text" name="longitude" id="lng_input" class="form-control" required value="<?php echo e(old('longitude', '44.1910')); ?>">
                            </div>
                        </div>

                        <div class="form-group mt-3">
                            <label for="address">العنوان التفصيلي</label>
                            <input type="text" name="address" id="address" class="form-control" value="<?php echo e(old('address')); ?>" placeholder="الشارع، الحي، أقرب معلم">
                        </div>
                    </div>
            ...
            <div class="card-footer text-right bg-light">
                <a href="<?php echo e(route('admin.hospitals.index')); ?>" class="btn btn-secondary mr-2">إلغاء</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\emergency_response_system\resources\views/admin/hospitals/create.blade.php ENDPATH**/ ?>