<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('hospital.dashboard')); ?>" class="nav-link">الرئيسية (المستشفى)</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $latestUnread; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <a href="<?php echo e(route('hospital.notifications.update', $notification->id)); ?>" class="dropdown-item">
            ...
            <a href="<?php echo e(route('hospital.notifications.index')); ?>" class="dropdown-item dropdown-footer">عرض جميع الإشعارات</a>
        </div>
      </li>
...
<?php /**PATH C:\xampp\htdocs\emergency_response_system\resources\views/layouts/includes/hospital_navbar.blade.php ENDPATH**/ ?>