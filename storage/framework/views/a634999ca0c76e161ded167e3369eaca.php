...
<div class="wrapper">
  ...
  <?php echo $__env->make('layouts.includes.hospital_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> 
  <?php echo $__env->make('layouts.includes.hospital_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  ...
  <footer class="main-footer">
    <strong>جميع الحقوق محفوظة &copy; <?php echo e(date('Y')); ?> نظام الإسعاف الطارئ</strong>
  </footer>
</div>
...
<?php /**PATH C:\xampp\htdocs\emergency_response_system\resources\views/layouts/hospital.blade.php ENDPATH**/ ?>