...
<?php $__env->startSection('title', 'سجل إشعارات المدير'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <form action="<?php echo e(route('admin.notifications.markAllAsRead')); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr <?php if(!$notification->is_read): ?> class="table-warning font-weight-bold" <?php endif; ?>>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('admin.notifications.update', $notification->id)); ?>" method="POST" style="display: inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <button type="submit" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\emergency_response_system\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>