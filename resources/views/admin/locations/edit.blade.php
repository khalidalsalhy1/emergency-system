...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">تعديل الموقع الجغرافي #{{ $location->id }}</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div class="card card-warning card-outline shadow">
            <form action="{{ route('admin.locations.update', $location->id) }}" method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        {{-- الجانب الأيمن: البيانات (مثل تنسيق الإضافة تماماً) --}}
                        <div class="col-md-5">
                            <fieldset class="mb-3 p-3 border rounded">
                                <legend class="w-auto px-2">بيانات الموقع</legend>
                                <div class="form-group">
                                    <label>العنوان الوصفي</label>
                                    <textarea name="address" class="form-control" rows="2" required>{{ old('address', $location->address) }}</textarea>
                                </div>
                            </fieldset>

                            {{-- ميزة اللصق السريع (بنفس اللون الأصفر) --}}
                            ...
                            <fieldset class="mb-3 p-3 border rounded">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="lat_input" name="latitude" class="form-control" value="{{ $location->latitude }}" required>
                                    </div>
                                    <div class="col-6">
                                        <label>خط الطول (Lng)</label>
                                        <input type="text" id="lng_input" name="longitude" class="form-control" value="{{ $location->longitude }}" required>
                                    </div>
                                </div>
                        ...
                        {{-- الجانب الأيسر: البحث والخريطة (7 أعمدة) --}}
                        <div class="col-md-7">
                            <div class="form-group">
                            ...
                            {{-- إجبار الارتفاع على 600px بنفس التنسيق المرفق --}}
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{ route('admin.locations.index') }}" class="btn btn-default btn-lg float-left">إلغاء</a>
                </div>
            </form>
        </div>
    </div>
